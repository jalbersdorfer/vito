...
#DEF:BrennerStarts=/usr/share/vito/vito.rrd:BrennerStarts:AVERAGE \
#DEF:BrennerStunden1=/usr/share/vito/vito.rrd:BrennerStunden1:AVERAGE \
#DEF:BrennerStunden2=/usr/share/vito/vito.rrd:BrennerStunden2:AVERAGE \
#CDEF:GBrennerStarts=BrennerStarts,100,/ \
#LINE1:GBrennerStarts#66cdaa:BrennerStarts \
#LINE1:BrennerStunden1#ba55d3:BrennerStunden1 \
#LINE1:BrennerStunden2#9370db:BrennerStunden2 \

rrdtool graph /usr/share/vito/vito12h.png -a PNG \
--start end-12h  --end now --width 800 --height 300 \
...
cp /usr/share/vito/vito12h.png /usr/share/nginx/www/
